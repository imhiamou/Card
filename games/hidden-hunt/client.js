/* Hidden Hunt — Game Mode 1 client module */
function registerHiddenHunt(socket){
...
HiddenHuntGame.onStart=onHiddenHuntStart;
HiddenHuntGame.onPlayerLeft=onHiddenHuntPlayerLeft;
HiddenHuntGame.onError=onHiddenHuntError;
}

const HiddenHuntGame={register:registerHiddenHunt};
window.HiddenHuntGame=HiddenHuntGame;
}
