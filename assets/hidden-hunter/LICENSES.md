...
The tracker is Kenney's Woman Green gun pose, one cell per direction. The pistol in each saved cell points 90 degrees clockwise of the filename, so the game maps world aim onto the cell that actually faces that way: left.png faces up, up.png faces right, right.png faces down, and down.png faces left, with the diagonals shifted the same way. The cell is not rotated at draw time. Standing and walking both hold that aim cell. Facing does not follow travel.
